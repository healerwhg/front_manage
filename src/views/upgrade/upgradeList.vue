        ...
        <div class="table-data" ref="tableContainer">
          ...
          >
            <el-table-column
              ...
              fixed
            />
            <el-table-column prop="address" label="钱包地址" width="360" align="center" />
            <el-table-column prop="amount" label="金额" width="100" align="center" />
            <el-table-column prop="burn_amount" label="烧伤金额" width="200" align="center" />
            <el-table-column prop="is_dividend" label="是否分红"  width="100" align="center">
              <template slot-scope="scope">
                <P>{{ scope.row.is_dividend? "是" : "否" }}</P>
              </template>
            </el-table-column>
            <el-table-column prop="cloud_dividend" label="云算力分红" width="260" align="center" />
            ...
            <el-table-column prop="status_str" width="100" label="交易状态" align="center" />
            <el-table-column prop="order_id"  width="300" label="订单号" align="center" />
            <el-table-column prop="extime" label="过期时间" width="180" align="center" />
...
<script>
import { getUpgradeList, getUpgradeStatusList } from "@api/upgrade"; // 引用./src/api/member.js中的'getMemberList'方法
...
export default {
  ...
  methods: {
    //状态列表
    async getStatusList() {
      let res = await getUpgradeStatusList();
    ...
    async getData(tempParams) {
       ...
       * 请求接口数据
       */
      let res = await getUpgradeList(tempParams);
