      ...
      <div class="table-container" id="tableContainer">
        <div class="table-data" ref="tableContainer">
          ...
          >
            ...
            <el-table-column prop="money" label="金额" width="260" align="center" />
            <el-table-column prop="status_str" width="100" label="交易状态" align="center" />
            <el-table-column prop="ctype" label="类型"  width="100" align="center">
              <template slot-scope="scope">
                <P>{{ scope.row.ctype == 1 ? "EEOQ" : "USDT" }}</P>
              </template>
            </el-table-column>
            <el-table-column prop="order_id"  width="300" label="订单号" align="center" />
            <el-table-column prop="tstime" label="交易时间"  width="180" align="center" />
...
<script>
import { getUpgrade} from "@api/upgrade"; // 引用./src/api/member.js中的'getMemberList'方法
...
export default {
  ...
  methods: {
    ...
    async getData(tempParams) {
       ...
       * 请求接口数据
       */
      let res = await getUpgrade(tempParams);
