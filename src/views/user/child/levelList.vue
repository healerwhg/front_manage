      ...
      <div class="table-container" id="tableContainer">
        <div class="table-data" ref="tableContainer">
          ...
          >
            ...
            <el-table-column prop="channel_str" label="类型" align="center" />
...
<script>
import { getLevelList, getLevelStatusList } from "@api/user"; // 引用./src/api/member.js中的'getMemberList'方法
...
export default {
  ...
  methods: {
    //状态列表
    async getStatusList() {
      let res = await getLevelStatusList();
    ...
    async getData(tempParams) {
       ...
       * 请求接口数据
       */
      let res = await getLevelList(tempParams);
