        ...
        <div class="table-data" ref="tableContainer">
          ...
          >
            ...
            <el-table-column
              ...
              fixed
            />
            <el-table-column prop="level" width="80"  label="用户等级" align="center" />
            <el-table-column prop="tposition" width="80" label="33位置" align="center" />
            <el-table-column
              prop="cloud_power"
              label="云算力"
              align="center"
            ...
            <el-table-column
              prop="freeze_bbalance"
              label="冻结EEOQ"
              align="center"
              min-width="100"
            />
            <el-table-column
              prop="freeze_ubalance"
              label="冻结USDT"
              align="center"
              min-width="100"
            />
            <el-table-column prop="bbalance" min-width="280" label="EEOQ余额" align="center" />
            <el-table-column prop="ubalance" min-width="280" label="USDT余额" align="center" />
            <el-table-column
              prop="parent"
              min-width="360"
              label="推荐人地址"
...
<script>
import { getUserList } from "@api/user"; // 引用./src/api/member.js中的'getMemberList'方法
...
export default {
  ...
  methods: {
    ...
    async getData(tempParams) {
       ...
       * 请求接口数据
       */
      let res = await getUserList(tempParams);
