...
<script>
import { getEEOQList, getEEOQStatusList } from "@api/user"; // 引用./src/api/member.js中的'getMemberList'方法
...
export default {
  ...
  methods: {
    //状态列表
    async getStatusList() {
      let res = await getEEOQStatusList();
    ...
    async getData(tempParams) {
       ...
       * 请求接口数据
       */
      let res = await getEEOQList(tempParams);
