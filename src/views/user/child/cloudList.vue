      ...
      <div class="table-container" id="tableContainer">
        <div class="table-data" ref="tableContainer">
          ...
          >
            ...
            <el-table-column prop="total_cloud_power" label="云算力" align="center" />
            <el-table-column prop="total_dividends" label="分红" align="center" />
            <el-table-column prop="real_time_price" label="实时价格" align="center" />
            <el-table-column prop="status_str" label="类型" align="center" />
...
<script>
import { getCloudList, getCloudStatusList } from "@api/user"; // 引用./src/api/member.js中的'getMemberList'方法
...
export default {
  ...
  methods: {
    //状态列表
    async getStatusList() {
      let res = await getCloudStatusList();
    ...
    async getData(tempParams) {
       ...
       * 请求接口数据
       */
      let res = await getCloudList(tempParams);
